...
# Exercise 2: Business Rule Extraction (⭐⭐ Medium - 45 minutes)
...
## 📋 Prerequisites
- Completed Exercise 1 (COBOL Analyzer)
...
- [Business Rules Engines Overview](https://martinfowler.com/bliki/RulesEngine.html)
...
Ready for the complete migration? Move on to [Exercise 3: Hybrid Banking System](/docs/modules/module-27/exercise3-overview) where you'll create a production system with COBOL and modern AI working together!