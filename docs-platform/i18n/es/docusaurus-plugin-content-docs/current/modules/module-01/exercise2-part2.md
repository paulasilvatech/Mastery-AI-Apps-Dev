...
description: "## 🚀 Part 2: Building the CLI Interface"
---

# Ejercicio 2: Building a CLI Tool (⭐⭐ Medio) - Partee 2

## 🚀 Partee 2: Building the CLI Interface

Now let's create the command-line interface that users will interact with.

### Step 5: Create the Main CLI Structure

Abrir `starter/task_manager/cli.py` and let's build the CLI:
...
Comience con imports and basic structure:
```python
import click
...
- `task done` - Completar tasks
- `task search` - Find tasks
- `task stats` - View statistics
- `task clear` - Clean up completed tasks

**Siguiente**: Continuar to [Partee 3](./exercise2-part3) where we'll add advanced features and testing!
