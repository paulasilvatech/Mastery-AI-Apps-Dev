...
Ready for the ultimate challenge? Move on to [Exercise 3: Distributed Problem Solver](/docs/modules/module-24/exercise3-overview) where you'll build a system that coordinates agents to solve complex computational problems!