...
# Ejercicio 2: Multi-ambiente Infrastructure with Terraform (⭐⭐ Medio)
...
- Multiple ambientes (dev, staging, producción)
...
## 📝 Partee 1: Configurar Remote State Atrásend
