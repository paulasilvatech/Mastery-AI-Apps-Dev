...
# Exercício 3: Completar GitOps Pipeline (⭐⭐⭐ Difícil)
...
- Implement a produção-grade GitOps workflow
- Automate infrastructure implantação on Git commits
...
- Cost estimation before implantação
