...
# Exercício 2: CQRS with Event Sourcing - Partee 2 (⭐⭐ Application)
...
In Partee 2, you'll complete the CQRS system by implementing event projections that build optimized read models from the event stream, creating query handlers, and adding caching for performance.
...
## 🚀 Partee 2: Query Side Implementation
...
4. **Saga Integration**: Connect to Exercício 3
...
Congratulations on implementing CQRS with Event Sourcing! Continuar to Exercício 3 where you'll build a distributed saga.

[Continuar to Exercício 3 →](../exercise3-saga/instructions.md)