...
In this foundational exercise, you'll implement a complete blue-green despliegue system with zero-downtime switching. You'll use GitHub Copilot to accelerate desarrollo of despliegue scripts, health checks, and traffic management.
...
1. Build a blue-green despliegue infrastructure
2. Implement health check endpoints
3. Create automated traffic switching
4. Handle database migrations safely
5. Implement rollback procedures
6. Monitor despliegue status

## 📚 Concepts Covered

### Blue-Green despliegue Pattern

Blue-green despliegue maintains two identical producción ambientes:
...
**Expected Output:**
Create `kubernetes/blue-despliegue.yaml`:
```yaml
apiVersion: apps/v1
kind: Deployment
metadata:
...
## 💻 Partee 2: despliegue Automation

### Step 4: Create despliegue Script
