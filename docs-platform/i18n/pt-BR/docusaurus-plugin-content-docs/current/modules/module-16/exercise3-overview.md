...
- Azure assinatura with Sentinel enabled
...
### Step 4: Create Security Painel API
...
Create implantação configuration:
...
6. **Real-time Atualizars**: Provide WebSocket security feed
...
- [Microsoft Sentinel Documentação](https://learn.microsoft.com/azure/sentinel/)
- [Microsoft Defender for Cloud](https://learn.microsoft.com/azure/defender-for-cloud/)
- [NIST Cybersecurity Framework](https://www.nist.gov/cyberframework)
- [Microsoft Entra ID Developer Guia](https://learn.microsoft.com/entra/identity-platform/)
