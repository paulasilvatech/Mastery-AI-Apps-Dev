...
# Ejercicio 2: Multi-Modal Agent System (⭐⭐ Medio - 45 minutos)

## 🎯 Objective
Implement a sophisticated multi-modal AI agent system that can process text, voice, images, and documents using Azure AI services, building upon the enterprise framework from Ejercicio 1.
...
- Azure suscripción with AI services
...
1. **Actualizar Azure service configurations:**
```powershell
...
3. **Avanzado Document Processing:**
...
- [Azure Cognitive Services Documentación](https://docs.microsoft.com/azure/cognitive-services/)
- [Speech Service Documentación](https://docs.microsoft.com/azure/cognitive-services/speech-service/)
- [Computer Vision Documentación](https://docs.microsoft.com/azure/cognitive-services/computer-vision/)
- [Form Recognizer Documentación](https://docs.microsoft.com/azure/applied-ai-services/form-recognizer/)

## ⏭️ Siguiente Ejercicio

Ready to add compliance and security features? Move on to [Ejercicio 3: Compliance-Ready Platform](/docs/modules/module-26/exercise3-overview) where you'll implement GDPR, HIPAA, and enterprise security!