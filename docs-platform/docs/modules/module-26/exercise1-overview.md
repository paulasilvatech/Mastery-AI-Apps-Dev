...
# Exercise 1: Enterprise Agent Framework (⭐ Easy - 30 minutes)
...
- Completed module prerequisites setup

## 📚 Background

Enterprise AI agents require a robust architectural foundation that ensures:
...
Create `Infrastructure/Services/AzureOpenAIService.cs`:
```csharp
using Azure;
...
- [Domain-Driven Design Fundamentals](https://learn.microsoft.com/en-us/dotnet/architecture/microservices/microservice-ddd-cqrs-patterns/)
- [MediatR Documentation](https://github.com/jbogard/MediatR)
- [Semantic Kernel Documentation](https://learn.microsoft.com/semantic-kernel/)

## ⏭️ Next Exercise

Ready to add multi-modal capabilities? Move on to [Exercise 2: Multi-Modal Agent System](/docs/modules/module-26/exercise2-overview) where you'll implement voice, vision, and document processing!