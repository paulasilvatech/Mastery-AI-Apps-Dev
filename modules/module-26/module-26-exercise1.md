...
Ready to add multi-modal capabilities? Move on to [Exercise 2: Multi-Modal Agent System](../exercise2-multimodal-agents/) where you'll implement voice, vision, and document processing!