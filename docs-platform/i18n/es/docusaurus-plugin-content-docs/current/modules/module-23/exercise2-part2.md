...
# Ejercicio 2: Database MCP Gateway - Partee 2
...
Ready for the final challenge? Move on to [Ejercicio 3: Multi-Server MCP Client](/docs/modules/module-23/exercise3-overview) where you'll build an intelligent agent that uses multiple MCP servers!