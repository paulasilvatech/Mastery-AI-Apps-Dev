...
create_module_structure() {
    ...
    directories=(
        ...
        "exercises/exercise2-terraform-multienv/starter"
        "exercises/exercise2-terraform-multienv/solution"
        "exercises/exercise2-terraform-multienv/tests"
        "exercises/exercise2-terraform-multienv/modules/network"
        "exercises/exercise2-terraform-multienv/modules/webapp"
        "exercises/exercise2-terraform-multienv/environments"
        "exercises/exercise3-gitops-automation/starter"
        "exercises/exercise3-gitops-automation/solution"
        "exercises/exercise3-gitops-automation/tests"
        "exercises/exercise3-gitops-automation/.github/workflows"
        "exercises/exercise3-gitops-automation/policies"
