...
# Ejercicio 2: Event-Driven Microservices - Partee 1: Service Architecture and Setup
...
- Set up desarrollo ambiente with Docker
...
### 1.2 Create ComParteird Proyectos
...
### 1.3 Install ComParteird Dependencies
...
## 📦 Step 2: Define ComParteird Contracts

### 2.1 Create Base Event Types

Create `src/Compartird/Contracts/Events/IEvent.cs`:
...
Create `src/Compartird/Contracts/Events/OrderEvents.cs`:
...
Create `src/Compartird/Contracts/Events/InventoryEvents.cs`:
...
Create `src/Compartird/Contracts/Events/PaymentEvents.cs`:
...
Create `src/Compartird/Infrastructure/EventStore/IEventStore.cs`:
...
Create `src/Compartird/Infrastructure/EventStore/MongoEventStore.cs`:
...
Create `src/Compartird/Infrastructure/Domain/AggregateRoot.cs`:
...
Create `src/Compartird/Infrastructure/Messaging/ServiceBusConfiguration.cs`:
...
Create `src/Compartird/Infrastructure/Sagas/SagaBase.cs`:
...
## 🐳 Step 5: Create Docker desarrollo ambiente
...
### 5.2 Create desarrollo Configuration
...
- [ ] Set up Docker desarrollo ambiente
...
- Configured desarrollo ambiente with Docker
