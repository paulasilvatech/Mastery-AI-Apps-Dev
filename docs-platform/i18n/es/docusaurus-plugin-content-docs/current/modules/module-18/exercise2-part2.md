...
# Ejercicio 2: CQRS with Event Sourcing - Partee 2 (⭐⭐ Application)
...
4. **Saga Integration**: Connect to Ejercicio 3
...
Congratulations on implementing CQRS with Event Sourcing! Continuar to Ejercicio 3 where you'll build a distributed saga.

[Continuar to Ejercicio 3 →](../exercise3-saga/instructions.md)