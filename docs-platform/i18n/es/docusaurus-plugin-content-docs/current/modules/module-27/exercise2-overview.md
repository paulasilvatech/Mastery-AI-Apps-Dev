...
# Ejercicio 2: Business Rule Extraction (⭐⭐ Medio - 45 minutos)
...
## 📋 Prerrequisitos
- Completard Ejercicio 1 (COBOL Analyzer)
...
- **Versión Control**: Ruta rule changes over time
...
1. **Avanzado Pattern Recognition:**
...
- [Business Rules Engines Resumen](https://martinfowler.com/bliki/RulesEngine.html)
- [Drools Documentación](https://www.drools.org/learn/documentation.html)
...
Ready for the complete migration? Move on to [Ejercicio 3: Hybrid Banking System](/docs/modules/module-27/exercise3-overview) where you'll create a producción system with COBOL and modern AI working together!