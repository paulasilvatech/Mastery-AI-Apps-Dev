...
# Módulo 13: Infrastructure as Code - Pré-requisitos
...
### Technical Skills
- 🐍 **Python**: Intermediário level (for automation scripts)
- ☁️ **Azure Fundamentos**: Resource groups, assinaturas, basic services
...
**Próximo Step**: Once prerequisites are met, start with [Exercício 1: Bicep Basics](./exercises/exercise1-bicep-basics/)