...
# Exercício 2: Database MCP Gateway - Partee 2
...
### Step 9: Create Configuration Módulo
...
Ready for the final challenge? Move on to [Exercício 3: Multi-Server MCP Client](/docs/modules/module-23/exercise3-overview) where you'll build an intelligent agent that uses multiple MCP servers!