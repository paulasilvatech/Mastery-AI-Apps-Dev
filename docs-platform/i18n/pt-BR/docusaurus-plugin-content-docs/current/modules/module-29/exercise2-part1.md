...
# Exercício 2: Event-Driven Microservices - Partee 1: Service Architecture and Setup
...
- Set up desenvolvimento ambiente with Docker
...
### 1.2 Create ComParteilDifícil Projetos
...
### 1.3 Install ComParteilDifícil Dependencies
...
## 📦 Step 2: Define ComParteilDifícil Contracts

### 2.1 Create Base Event Types

Create `src/Compartilhard/Contracts/Events/IEvent.cs`:
...
Create `src/Compartilhard/Contracts/Events/OrderEvents.cs`:
...
Create `src/Compartilhard/Contracts/Events/InventoryEvents.cs`:
...
Create `src/Compartilhard/Contracts/Events/PaymentEvents.cs`:
...
Create `src/Compartilhard/Infrastructure/EventStore/IEventStore.cs`:
...
Create `src/Compartilhard/Infrastructure/EventStore/MongoEventStore.cs`:
...
Create `src/Compartilhard/Infrastructure/Domain/AggregateRoot.cs`:
...
Create `src/Compartilhard/Infrastructure/Messaging/ServiceBusConfiguration.cs`:
...
Create `src/Compartilhard/Infrastructure/Sagas/SagaBase.cs`:
...
## 🐳 Step 5: Create Docker desenvolvimento ambiente
...
### 5.2 Create desenvolvimento Configuration
...
Before moving to Partee 2, ensure you have:
...
- [ ] Set up Docker desenvolvimento ambiente
...
- Configured desenvolvimento ambiente with Docker
- Established shared contracts for service communication

## ⏭️ Próximos Passos

Continuar to [Partee 2: Core Services Implementation](./exercise1-part2) where you'll:
