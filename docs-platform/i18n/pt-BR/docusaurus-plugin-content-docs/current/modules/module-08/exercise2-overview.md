...
# Exercício 2: Building a GraphQL Social Platform API (⭐⭐ Médio)

## 📋 Visão Geral

In this exercise, you'll create a GraphQL API for a social platform with complex relationships, efficient data loading, and real-time assinaturas. You'll learn how GraphQL differs from REST and how to leverage its powerful features for building modern APIs.
