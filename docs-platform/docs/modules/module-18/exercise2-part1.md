...
# Exercise 2: CQRS with Event Sourcing - Part 1 (⭐⭐ Application)
...
In this application-level exercise, you'll build a CQRS (Command Query Responsibility Segregation) system with Event Sourcing for an e-commerce platform. Part 1 focuses on the command side and event store, while Part 2 covers projections and query models.
...
## 🚀 Part 1: Command Side Implementation
...
You've successfully built the command side! Continue to Part 2 where you'll implement projections and query models.
