...
# Ejercicio 2: Multi-ambiente despliegue (⭐⭐)
...
- Create multi-stage despliegue pipelines
- Implement ambiente-specific configurations
- Use GitHub Environments with protection rules
- Deploy to Azure App Service
- Implement blue-green despliegue strategy
- Add automated smoke tests
- Configure rollback mechanisms

## 📋 Scenario

Your team wants to implement a proper despliegue pipeline with multiple ambientes (desarrollo, staging, producción). Each ambiente should have its own configuration, approval process, and despliegue strategy. You'll deploy to Azure App Service with zero-downtime despliegues.
...
### Step 3: Create despliegue Workflow

Now let's create a comprehensive despliegue workflow:
...
**Continuar to Partee 2 for application despliegue and testing...**