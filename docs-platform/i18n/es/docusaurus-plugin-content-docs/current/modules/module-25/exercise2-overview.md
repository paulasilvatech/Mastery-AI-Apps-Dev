...
# Ejercicio 2: Monitoring & Alerting System (⭐⭐ Medio - 45 minutos)

## 🎯 Objective
Implement a comprehensive monitoring and alerting system for producción AI agents, including metrics collection, visualization, distributed tracing, log aggregation, and intelligent alerting.
...
- **Panels**: Visual representation of system health
...
- [Grafana Panel Guía](https://grafana.com/docs/grafana/latest/dashboards/)
- [Distributed Tracing](https://opentracing.io/docs/)
- [SRE Workbook](https://sre.google/workbook/)

## ⏭️ Siguiente Ejercicio

Ready for the ultimate challenge? Move on to [Ejercicio 3: Disaster Recovery System](/docs/modules/module-25/exercise3-overview) where you'll implement automated backup and recovery!