...
Ready for more? Move on to [Exercise 2: Database MCP Gateway](/docs/modules/module-23/exercise2-overview) where you'll create an MCP server for database access!