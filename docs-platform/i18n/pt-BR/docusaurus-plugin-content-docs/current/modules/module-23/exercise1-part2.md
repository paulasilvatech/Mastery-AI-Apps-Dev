...
# Exercício 1: File System MCP Server - Partee 2
...
Atualizar `src/server/MCPFileSystemServer.ts` to add tool processing:
...
Ready for more? Move on to [Exercício 2: Database MCP Gateway](/docs/modules/module-23/exercise2-overview) where you'll create an MCP server for database access!