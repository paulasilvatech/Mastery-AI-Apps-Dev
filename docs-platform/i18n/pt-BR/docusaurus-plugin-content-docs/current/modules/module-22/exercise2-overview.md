...
# Exercício 2: Database Migration Agent (⭐⭐ Médio - 45 minutos)
...
5. **Performance Monitoring**: Trilha migration impact on database performance

## 📚 Additional Recursos

- [Flyway Documentação](https://flywaydb.org/)
...
Ready for the final challenge? Move on to [Exercício 3: Architecture Decision Agent](../exercise3-hard/README.md)!