...
### [Exercise 1: Enterprise API Platform](./exercise1-overview) ⭐
...
### [Exercise 2: Event-Driven Microservices](./exercise2-overview) ⭐⭐
Create a distributed system using microservices, event sourcing, and saga orchestration for complex workflows.

### [Exercise 3: AI-Powered Enterprise System](./exercise3-overview) ⭐⭐⭐
...
Ready to demonstrate your mastery? Start with the [prerequisites](prerequisites.md) to set up your environment, then dive into [Exercise 1](./exercise1-overview)!
