...
# Exercício 2: Create a Code Revisar Agent with Custom Rules (⭐⭐ Médio - 45 minutos)
...
- [AST Módulo Documentação](https://docs.python.org/3/library/ast.html)
- [Git Diff Format](https://git-scm.com/docs/diff-format)
- [Code Revisar Melhores Práticas](https://google.github.io/eng-practices/review/)

## ⏭️ Próximo Exercício

Ready for the ultimate challenge? Move on to [Exercício 3: Multi-Step Refactoring Agent](../exercise3-hard/README.md)!