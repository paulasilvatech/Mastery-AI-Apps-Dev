...
# Exercício 2: Building a CLI Tool (⭐⭐ Médio) - Partee 2
...
Comece com imports and basic structure:
```python
import click
...
**Próximo**: Continuar to [Partee 3](./exercise2-part3) where we'll add advanced features and testing!
