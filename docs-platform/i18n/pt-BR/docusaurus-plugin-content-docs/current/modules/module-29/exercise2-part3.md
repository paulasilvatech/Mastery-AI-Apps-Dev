...
# Exercício 2: Event-Driven Microservices - Partee 3: Saga Integration and Testing
...
- Completar saga orchestration with timeout handling
...
## 🔄 Step 1: Completar Saga Orchestration

### 1.1 Add Timeout Handling to Saga

Atualizar `src/Services/Order/Sagas/OrderSaga.cs`:
...
- ✅ Less than 5 second end-to-end processing
- ✅ 99.9% success rate
...
3. Move on to [Exercise 3: AI-Powered Enterprise System](/docs/modules/module-29/exercise3-overview)
