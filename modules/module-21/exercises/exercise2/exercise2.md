# Exercise 2: Create a Code Review Agent with Custom Rules (⭐⭐ Medium - 45 minutes)
...
### Step 1: Create Review Agent Architecture
...
1. **Add Language Support**: Extend to JavaScript, TypeScript, Go
...
Ready for the ultimate challenge? Move on to [Exercise 3: Multi-Step Refactoring Agent](../exercise3-hard/README.md)!