...
# Ejercicio 3: Event-Driven Serverless System ⭐⭐⭐

## Resumen

In this advanced exercise, you'll build a producción-ready event processing system that combines AKS-hosted microservices with Azure Functions, implementing complex event-driven patterns, durable workflows, and real-time processing at scale. This represents a real-world hybrid cloud-native architecture.
...
- Running AKS cluster from Ejercicio 2
...
- **Inventory Actualizars**: Real-time stock tracking
- **Análisis**: ML-based demand forecasting
- **IoT Integration**: Warehouse sensor data
- **Event Sourcing**: Completar audit trail
- **Complex Workflows**: Multi-step order fulfillment

## 🚀 Partee 1: Azure Functions Setup
