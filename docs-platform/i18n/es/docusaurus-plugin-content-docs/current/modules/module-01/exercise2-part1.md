...
# Ejercicio 2: Building a CLI Tool (⭐⭐ Medio) - Partee 1
...
- Buscar and filter capabilities
- Data persistence
...
4. **Utils** (`utils.py`) - Ayudaer functions
...
Comience con imports and enums:
```python
...
**Siguiente**: Continuar to [Partee 2](./exercise2-part2) where we'll build the CLI interface!
