...
In this foundational exercise, you'll implement a complete blue-green implantação system with zero-downtime switching. You'll use GitHub Copilot to accelerate desenvolvimento of implantação scripts, health checks, and traffic management.
...
1. Build a blue-green implantação infrastructure
2. Implement health check endpoints
3. Create automated traffic switching
4. Handle database migrations safely
5. Implement rollback procedures
6. Monitor implantação status

## 📚 Concepts Covered

### Blue-Green implantação Pattern

Blue-green implantação maintains two identical produção ambientes:
- **Blue**: Current live ambiente serving traffic
...
## 🛠️ Partee 1: Infrastructure Setup
...
**Expected Output:**
Create `kubernetes/blue-implantação.yaml`:
```yaml
apiVersion: apps/v1
kind: Deployment
metadata:
...
## 💻 Partee 2: implantação Automation

### Step 4: Create implantação Script
...
Continuar to [Partee 2](./exercise1-part2) for testing, validation, and advanced scenarios...