...
# Ejercicio 3: Empresarial Pipeline with AI (⭐⭐⭐)
...
- Create adaptive despliegue strategies based on metrics
...
You're the DevOps lead for an enterprise application serving millions of users. The CEO wants a "self-healing, self-optimizing" despliegue pipeline that can predict failures, optimize costs, and adapt despliegue strategies based on real-time metrics. You'll leverage AI at every stage of the pipeline.
...
### Step 2: Create Intelligent despliegue Strategy Selector

**.github/actions/despliegue-strategy/action.yml:**
...
**Continuar to Partee 2 for test generation and despliegue...**