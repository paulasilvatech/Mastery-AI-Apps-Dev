# Exercise 1: Building a RESTful Task Management API (Part 2)

## 🚀 Part 2: API Implementation and Testing
...
- Open http://localhost:8000/api/redoc for ReDoc
...
- **RESTful Design**: Resources, HTTP verbs, and status codes
