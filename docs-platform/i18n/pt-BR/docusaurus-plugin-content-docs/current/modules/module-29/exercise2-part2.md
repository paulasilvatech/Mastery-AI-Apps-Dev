...
# Exercício 2: Event-Driven Microservices - Partee 2: Core Services Implementation
...
Continuar to [Partee 3: Saga Integration and Testing](./exercise1-part3) where you'll:
- Completar the saga orchestration
