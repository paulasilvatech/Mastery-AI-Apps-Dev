...
# Ejercicio 1: Empresarial Agent Framework (⭐ Fácil - 30 minutos)
...
- [MediatR Documentación](https://github.com/jbogard/MediatR)
- [Semantic Kernel Documentación](https://learn.microsoft.com/semantic-kernel/)

## ⏭️ Siguiente Ejercicio

Ready to add multi-modal capabilities? Move on to [Ejercicio 2: Multi-Modal Agent System](/docs/modules/module-26/exercise2-overview) where you'll implement voice, vision, and document processing!