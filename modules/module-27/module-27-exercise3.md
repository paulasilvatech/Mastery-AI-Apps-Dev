# Exercise 3: Hybrid Banking System (⭐⭐⭐ Hard - 90 minutes)

## 🎯 Objective
Create a production-ready hybrid banking system where legacy COBOL core banking functions work seamlessly with modern AI services, implementing the strangler fig pattern for gradual migration.
...
- COBOL and Python environments ready
...
- **Retiring**: Eventually decommission legacy parts
...
- [Legacy Modernization Best Practices](https://www.redhat.com/en/topics/cloud-native-apps/legacy-modernization)

## 🎉 Congratulations!

You've successfully built a production-ready hybrid banking system that:
...
Ready for Module 28: Advanced DevOps & Security!