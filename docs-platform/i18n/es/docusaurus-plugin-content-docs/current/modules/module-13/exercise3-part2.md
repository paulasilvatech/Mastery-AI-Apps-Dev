...
# Ejercicio 3: Completar GitOps Pipeline (Partee 2)

## 📝 Partee 3: despliegue Workflows

### Step 4: Create despliegue Workflow

Create the main despliegue workflow that triggers on merge to main:
...
### Step 6: Create RollAtrás Workflow
...
### Step 9: Configurar Monitoring Panel
...
- ✅ Multi-ambiente despliegue pipeline
...
- [GitHub Actions Mejores Prácticas](https://docs.github.com/en/actions/guides)
- [OPA Documentación](https://www.openpolicyagent.org/docs/latest/)
- [Azure Monitor Documentación](https://docs.microsoft.com/en-us/azure/azure-monitor/)
...
**Siguiente Módulo**: [Módulo 14: CI/CD with GitHub Actions](../../module-14-cicd-github-actions/)
