...
# Exercício 3: Event-Driven Serverless System ⭐⭐⭐

## Visão Geral

In this advanced exercise, you'll build a produção-ready event processing system that combines AKS-hosted microservices with Azure Functions, implementing complex event-driven patterns, durable workflows, and real-time processing at scale. This represents a real-world hybrid cloud-native architecture.
...
- Running AKS cluster from Exercício 2
...
- **Inventory Atualizars**: Real-time stock tracking
- **Análises**: ML-based demand forecasting
