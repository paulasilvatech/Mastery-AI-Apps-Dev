...
# Exercício 2: Building a CLI Tool (⭐⭐ Médio) - Partee 3

## 🚀 Partee 3: Avançado Features and Testing
...
Let's add the ability to export and import tasks. Atualizar `cli.py` with new commands:
...
- Move on to [Exercício 3](./exercise3-part1) - Completar Application
- Revisar the [best practices](best-practices.md) guide
