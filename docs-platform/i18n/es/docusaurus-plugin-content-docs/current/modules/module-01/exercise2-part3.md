...
# Ejercicio 2: Building a CLI Tool (⭐⭐ Medio) - Partee 3

## 🚀 Partee 3: Avanzado Features and Testing
...
Let's add the ability to export and import tasks. Actualizar `cli.py` with new commands:
...
- Move on to [Ejercicio 3](./exercise3-part1) - Completar Application
