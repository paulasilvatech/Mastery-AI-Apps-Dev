...
description: "## 📝 Part 3: Deployment Workflows"
---

# Exercício 3: Completar GitOps Pipeline (Partee 2)

## 📝 Partee 3: implantação Workflows

### Step 4: Create implantação Workflow

Create the main implantação workflow that triggers on merge to main:
...
### Step 6: Create RollVoltar Workflow
...
## 📝 Partee 4: Integration and Testing
...
### Step 8: Run Completar Pipeline Test
...
### Step 9: Configurar Monitoring Painel
...
- ✅ Completar GitOps repository structure
- ✅ Automated validation and security scanning
- ✅ Multi-ambiente implantação pipeline
...
- [GitHub Actions Melhores Práticas](https://docs.github.com/en/actions/guides)
- [OPA Documentação](https://www.openpolicyagent.org/docs/latest/)
- [Azure Monitor Documentação](https://docs.microsoft.com/en-us/azure/azure-monitor/)
...
**Próximo Módulo**: [Módulo 14: CI/CD with GitHub Actions](../../module-14-cicd-github-actions/)
