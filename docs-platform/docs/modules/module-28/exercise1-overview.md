...
Ready for security automation? Move on to [Exercise 2: AI Security Operations](/docs/modules/module-28/exercise2-overview) where you'll build an autonomous security operations center!