...
Ready for the final challenge? Move on to [Exercise 3: Multi-Server MCP Client](../exercise3-multi-server/) where you'll build an intelligent agent that uses multiple MCP servers!